...
def ctct(num):
    ...
    with open('./ClearFirstList.txt', 'rt', encoding='utf-8') as f:
        for line1 in f:
            ...
            tmp1 = face_recognition.load_image_file('./face/' + video_information[2] + '.jpg')
...
def main():
    ...
    # cc(1)
    try:
        p0 = multiprocessing.Process(target=ctct, args=(0, ))
        p1 = multiprocessing.Process(target=ctct, args=(1, ))
        p2 = multiprocessing.Process(target=ctct, args=(2, ))
        p3 = multiprocessing.Process(target=ctct, args=(3, ))
        p4 = multiprocessing.Process(target=ctct, args=(4, ))
        p5 = multiprocessing.Process(target=ctct, args=(5, ))
        p6 = multiprocessing.Process(target=ctct, args=(6, ))
        p7 = multiprocessing.Process(target=ctct, args=(7, ))
        ...
        with open('./FinishClearFirst.txt', 'w', encoding='utf-8') as f:
            f.write('cnm!')
